...
public class ClassificationTest {
	...
	static DiseaseOrganService dos = new DiseaseOrganService();
	...
	private static void tiQuUrl2(String key) {
		for (int i = 0; i < 1; i++) {
			...
			String url = "http://jbk.39.net" + key.substring(i11, i12 - 1) + "_t1/";
		...
		for (int i = 1; i < 200; i++) {
			...
			String url = "http://jbk.39.net" + key.substring(i11, i12 - 1) + "_t1_p" + i + "#ps";
			System.out.println(url);
			String name = removeLabel(key);
			String htmlString = null;
			try {
	...
	private static void tiQuUrl(String string) {
		for (int i = 1; i < 2; i++) {
			...
			String url = "http://jbk.39.net" + string.substring(i11, i12 - 1) + "_t1/";
		...
		for (int i = 1; i < 200; i++) {
			...
			String url = "http://jbk.39.net" + string.substring(i11, i12 - 1) + "_t1_p" + i + "#ps";
	...
	public static Map<String, String> anyString1(String html) {
		if (html != null && !html.equals("")) {
			...
			String s1 = "<div class=\"res_list\" dtype=\"1\" vtype=\"0\">";
			String s2 = "title";
			boolean flag = false;
			boolean flag2 = false;
			...
			for (String string : sList) {
				...
				String s21 = "href=\"http://jbk.39.net/";
